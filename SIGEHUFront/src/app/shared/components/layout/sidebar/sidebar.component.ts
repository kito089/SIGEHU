...
export class SidebarComponent {
  ...
  readonly navItems: NavItem[] = [
    ...
    { icon: 'budget', label: 'Presupuestos', route: '/admin/analitico' },
    { icon: 'inventory', label: 'Catálogo', route: '/admin/catalogo' },
    { icon: 'production', label: 'Fabricación', route: '/admin/fabricacion' },
