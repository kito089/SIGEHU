...
const getFotosByObra = async (idObra) => {
    ...
    return await db.query(
        `SELECT idFotoObra, Obras_idObra, EstadosObra_idEstadoObra, Trabajadores_idTrabajador,
                RutaArchivo, ContentType, FechaCreacion
         FROM FotosObras WHERE Obras_idObra = ?`,
        [idObra]
    );
};
