...
CREATE TABLE Obras (
    ...
    FechaLevantamiento TIMESTAMP,
    FechaFabricacion TIMESTAMP,
    FechaInstalacion TIMESTAMP,
    MedidasEnviadas BOOLEAN DEFAULT FALSE NOT NULL,
    MedidasResponsableIdTrabajador INTEGER,
    MedidasEnviadasPor INTEGER,
    MedidasEnviadasFecha TIMESTAMP,
    FechaCreacion TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
