...
-- =============================================================================
-- SECCIÓN 4B: NOTIFICACIONES POR CUENTA (SSE multidispositivo)
-- -----------------------------------------------------------------------------
-- Centro de notificaciones con asociación POR CUENTA (Trabajadores_idTrabajador).
-- Fuente de verdad única para sincronizar las sesiones simultáneas de un mismo
-- usuario (PC, Electron, Android) mediante el hub SSE del backend.
-- =============================================================================
